...
<% 
		...
		%> 
                <li class="list-inline-item"><a href="#" class="text-warning" >Bonjour <%= employeSession.getPrenomEmploye()%> <%= employeSession.getNomEmploye()%></a></li>
                <%};%>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="ident" method="post" action="<%=request.getContextPath()%>/ident" accept-charset="UTF-8">
                  <div class="form-group">
                    <input id="email-modal" name="email-modal" type="text" placeholder="votre email" value="dupont.joe@mail.com" required class="form-control">
                  </div>
                  <div class="form-group">
                    <input id="password-modal" name="password-modal" type="password" placeholder="votre mot de passe" value="dupjore12" required class="form-control">
                  </div>
                  <p class="text-center">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="<%=request.getContextPath()%>/e-cig/" class="navbar-brand home"><img src="<%=request.getContextPath()%>/img/logo.png" alt="Logo E-Cig" class="d-none d-md-inline-block"><img src="<%=request.getContextPath()%>/img/logo-small.png" alt="Logo E-Cig" class="d-inline-block d-md-none"><span class="sr-only">E-CIG - retour &aacute; l'accueil</span></a>
          <div class="navbar-buttons">
            ...
            <button type="button" data-toggle="collapse" data-target="#search" class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Basculer sur la recherche</span><i class="fa fa-search"></i></button>
            <a href="<%=request.getContextPath()%>/e-cig/panier" class="btn btn-outline-secondary navbar-toggler"><i class="fa fa-shopping-cart"></i></a>
          </div>
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item"><a class="nav-link active" href="<%=request.getContextPath()%>/e-cig/">Accueil</a></li>
              <li class="nav-item"><a href="<%=request.getContextPath()%>/e-cig/produit" class="nav-link">Nos Produits</a></li>
...
<!-- pages personnelles de chaque membre du groupe -->
                      <div class="col-md-6 col-lg-3">
                        <h5>La r&egrave;glementation </h5>
                        <ul class="list-unstyled mb-3">
