		...
		<div class="row">
			...
			<div class="col-lg-2">
				...
				<div class="card sidebar-menu mb-4">
					...
					<div class="card-boy">
						<ul class="nav nav-pills flex-column">
							<li><a href="<%=request.getContextPath()%>/e-cig/admin">
									<button type="button"
							...
							<div class="row">
								<div class="col-md-4">
									...
									<input id="idEmploye" class="form-control" type="text"
										name="idEmploye" placeholder="RE00" required>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<label for="prenomEmploye">Pr&eacute;nom usuel</label> <input
										...
										name="prenomEmploye" placeholder="prénom du salarié" size="50"
										required>
								</div>
								<div class="col-md-3">
							...
							<div class="row">
								<div class="col-md-6">
									<label for="adrEmploye">Adresse</label> <input id="adrEmploye"
										...
										placeholder="Adresse du salarié" size="70" required>
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-4">
									<label for="villeEmploye">Ville</label> <input
										...
										name="villeEmploye" placeholder="Ville du salarié" size="60"
										required>
								</div>
